...
import { Button, Card, CardBody, Flex, Heading, HStack, Icon, Image, Text, VStack } from '@chakra-ui/react';
    ...
    <Card>
      <CardBody>
        <VStack alignItems="start" spacing={8}>
          ...
          <Flex flexWrap="wrap" columnGap="12" justifyContent={{ base: 'center' }} w="100%">
            <VStack w="45%">
