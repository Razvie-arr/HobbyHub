    ...
    <ModalContent>
      ...
      <ModalBody p="8">
        <VStack justifyContent="center">
          ...
          <Text align="center">
            Thank you for your interest! Admin of the event received information about your application. You will
            receive an email notification right after his/her approval.
          </Text>
        </VStack>
      </ModalBody>
    </ModalContent>
